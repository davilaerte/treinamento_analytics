...
```{r desmistificandoR, include=TRUE}
...
# foi retornado um vetor contendo o numero de caracteres de
# cada nome do vetor udacious respectivamente.
...
# foi retornado um vetor com os elementos que tinham numero de 
# caracteres igual a 11.
...
# o primeiro comando mostra todas as variaveis e seus valores,
# e o segundo comando mostra as dimensões da tabela mtcars.
...
Para saber o que uma funcao faz:
?function

```{r helpR, include=TRUE}
# exemplo
?mean
...
le conjunto de dados

```{r readDado, include=TRUE}
...
# armazena os dados na variavel dado.
dado <- read.csv('stateData.csv')

# cria um subconjunto com os dados que tenham parametro state.region igual a 1.
subset(dado, state.region == 1)

# outra forma :)
dado[dado$state.region == 1,]

# exemplo, tabela com estados com taxa de anafalbetismo menor ou igual a 0.5%.

dado[dado$illiteracy <= 0.5,]

```

## Demystifying R Parte 2
========================================================
...
```{r}
# carrega dados do reddit
setwd('/home/davilaerte/Downloads')
reddit <- read.csv('reddit.csv')

# sumariza tipos de dados do reddit.
str(reddit)

# variavel de Fator, é uma variavel de categoria com diferentes niveis.

# para ver os levels de uma variavel.

levels(reddit$age.range)

```

Grafico de uma variavel fator
```{r GraficoVariavelFator, include=TRUE}
# plota o grafico
qplot(data = reddit, x = age.range)

# define uma ordem para uma variavel de fato, no caso age.range.
